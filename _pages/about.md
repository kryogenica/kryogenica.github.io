...
* Inferring network structure from its dynamics 🕸️ &harr; 〰️.
...
Award
======
My team and I secured a prestigious [National Science Foundation SBIR Phase I grant](https://www.nsf.gov/awardsearch/showAward?AWD_ID=2309896) worth $275K in 2023 for pioneering an artificial intelligence system to enhance transparency and predict trends in democratic elections through sentiment analysis and network theories.
...
* **Physics Research Assistant - Full time, Levich Institute** (Aug 2019 – Aug 2024) — New York, NY
  ...
  * Optimized integer linear programming scripts through A/B testing based on graph theory with NetworkX and GUROBI in Python, achieving network repair with 10× fewer modifications and reduced memory usage... [**(more in CV)**](/files/Bryant_Avila_Resume_Aug_2026.pdf)
...
* **Laboratory Manager - Full time, Fashion Institute of Technology** (Jan 2018 – Jan 2024) — New York, NY
  ...
  * Spearheaded the development of sustainable materials, collaborating with faculty on bacterial leather and mycelium projects, reducing growth times by 5 days and delivering results on time for semester reports... [**(more experiences in my CV)**](/files/Bryant_Avila_Resume_Aug_2026.pdf)
...
* B.S. in Physics - The City College of New York - Feb 2012 – Feb 2016
  ...
  * Advisors: [Carlos Meriles](https://cmeriles.ccny.cuny.edu/), [Brian Tiburzi](https://www.gc.cuny.edu/people/brian-c-tiburzi)
